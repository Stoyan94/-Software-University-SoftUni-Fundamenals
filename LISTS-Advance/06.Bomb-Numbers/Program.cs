       ...
       internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (numbers.Contains(bombNumber))
            {
              ...
              // bombPower → колко искаме да премахнем вляво.
              // bombIndex → колко всъщност има елементи вляво.
              // Math.Min избира по - малката стойност, за да не излезем извън границите на списъка.
              ...
              // bombPower → колко елемента бихме искали да премахнем вдясно.
              // numbers.Count - bombIndex - 1 → колко елемента всъщност има вдясно.
              // Math.Min избира по - малката стойност, за да избегне опит за премахване извън края на списъка.
